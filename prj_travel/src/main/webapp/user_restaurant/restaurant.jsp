...
<%
	...
	List<RestaurantVO> pageList = new ArrayList<RestaurantVO>();
	...
	if(selectTag == null || selectTag.equals("전체")){
		totalContent = dao.selectTotalRestaurant();
	} else {
		totalContent = dao.selectTotalTagRestaurant("#" + selectTag);
	}
							...
							<li class="map_paging" data-v-2fbcbd64="">
								<div class="map_paging_inner" data-v-2fbcbd64="">
									<div id="paging" class="page-wrap" data-v-2fbcbd64="">
										...
										<c:url var="firstPage" value="restaurant.jsp">
										...
										<c:url var="beforePage" value="restaurant.jsp">
										...
										<c:forEach begin="${startNum }" end="${endNum }" var="num">
											<c:url var="url" value="restaurant.jsp">
										...
										<c:url var="nextPage" value="restaurant.jsp">
