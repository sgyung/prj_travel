	...
	$(function() {
		...
		var tempResKeyword = "";
			 ...
			 $("#resSearch").click(function() {
				...
				resChkNull();
				$.ajax({
					url: "admin_board_restaurant.jsp",
					type: "post",
...
%>
             ...
             <div class="card-footer clearfix">
               <ul class="pagination justify-content-center" id="resPageOutput" >
                ...
                <form name = "resFrmSearch" id="resFrmSearch" action="admin_board_list.jsp" method="get">
...
%>
              ...
              <div class="card-footer clearfix">
               <ul class="pagination justify-content-center" id="tourPageOutput" >
                ...
                <div style="text-align: center" >
                <form name = "tourFrmSearch" id="tourFrmSearch" action="admin_board_list.jsp" method="get">
