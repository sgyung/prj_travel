...
<%
TourBusPageDAO tbpDAO = TourBusPageDAO.getInstance();
...
int totalCount = tbpDAO.tourBusTotalCount(pVO);
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">투어버스 목록</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body" style="height: 650px">
<form action="admin_tourbus_detail.jsp" method="post" id="tourbusFrm">
...
<%
	try{
		List<TourBusVO> list = null;

		if(currentPage != 0){
			list = tbpDAO.selectTourBus(pVO);
		}
...
%>	                  
              ...
              <div class="card-footer clearfix">
				...
				%>                    
                  <li class="page-item"><a class="page-link" href="admin_tourbus_list.jsp?currentPage=<%= movePage %>&keyword=${ param.keyword }&field=${ param.field }">&laquo;</a></li>
                <%
                    }else{
                %>
                ...
                %>
                  ...
                  %>
                  <li class="page-item"><a class="page-link" href = "admin_tourbus_list.jsp?currentPage=<%= movePage %>&keyword=${ param.keyword }&field=${ param.field }">
                  <%= movePage %></a></li>
                ...
                if( totalPage > endPage ){
				%>                    
                  <li class="page-item"><a class="page-link" href="admin_tourbus_list.jsp?currentPage=<%= movePage %>&keyword=${ param.keyword }&field=${ param.field }">&raquo;</a></li>
                <%
                    }else{
                %>
                ...
                <form name = "frmSearch" id="frmSearch" action="admin_tourbus_list.jsp" method="get">
                <select name="field" class="inputBox" style="height: 30px;">
					<option value="1"${ param.field eq '1'?"selected = 'selected'":"" }>버스이름</option>
				</select>
