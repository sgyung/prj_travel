...
<%@page import="pageUtil.RestaurantPageDAO"%>
...
<%
RestaurantPageDAO rpDAO = RestaurantPageDAO.getInstance();
...
int totalCount = rpDAO.restaurantTotalCount(pVO);
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">맛집 목록</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body" style="height: 650px">
              <form action="admin_restaurant_detail.jsp" method="post" id="restaurantFrm">
...
<%
	try{
		List<RestaurantVO> list = rpDAO.selectRestaurant(pVO);
...
%>
                    ...
                    <tr>
                      ...
                      <td><a href="#void" onclick="restaurantDetail('${ list.id }')"><c:out value="${ list.name }"/></a></td>
                      <td><c:out value="${ list.registraitionDate }"/></td>
                    </tr>
				</c:forEach>
                  </tbody>
                </table>
              ...
              <div class="card-footer clearfix">
				...
				%>                    
                  <li class="page-item"><a class="page-link" href="admin_restaurant_list.jsp?currentPage=<%= movePage %>&keyword=${ param.keyword }&field=${ param.field }">&laquo;</a></li>
                <%
                    }else{
                %>
                ...
                %>
                  ...
                  %>
                  <li class="page-item"><a class="page-link" href = "admin_restaurant_list.jsp?currentPage=<%= movePage %>&keyword=${ param.keyword }&field=${ param.field }">
                  <%= movePage %></a></li>
                ...
                if( totalPage > endPage ){
				%>                    
                  <li class="page-item"><a class="page-link" href="admin_restaurant_list.jsp?currentPage=<%= movePage %>&keyword=${ param.keyword }&field=${ param.field }">&raquo;</a></li>
                <%
                    }else{
                %>
                ...
                <form name = "frmSearch" id="frmSearch" action="admin_restaurant_list.jsp" method="get">
...
<%--<% for(int i=1 ; i < totalPage+1 ; i++){%>
	[ <a href="member_list.jsp?currentPage=<%= i %>&dataFlag=1&keyword=${ param.keyword }
<%}//end for%> --%>
...
String dataFlag=request.getParameter("dataFlag");
	RestaurantVO buVO=
	new RestaurantVO("member_list.jsp", dataFlag, keyword, field, currentPage, totalPage);
		
	out.println(RestaurantUtil.getInstance().pageNation(buVO));
%> --%>
