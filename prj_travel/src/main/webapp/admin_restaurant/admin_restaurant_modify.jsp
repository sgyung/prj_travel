...
<%
	...
	try{
		if( areaId != null){
			RestaurantVO resVO = rmDAO.selectRestaurant(areaId);
			
			String[] tagArr = resVO.getTags().split(" ");
			String[]  convenienceArr = resVO.getConveniences().split(",");
  ...
  <!-- /.navbar -->
    ...
    <div class="upload-box col-md-5">
      <div class="drag-file" id="drop-file">
        <img src="${ resVO.image }"  id="preview" style="display : inline">
      </div>
  	...
  	<input type="text" class="inputBox" id="name" name="name" style="width: 60%;display: inline-block; margin-left: 70px" placeholder="이름을 입력해주세요." value="${ resVO.name }"><br/>
  	<label style="margin-left: 30px; margin-top: 30px">주소</label>
  	<input type="text" class="inputBox" id="addr" name="addr" style="width: 60%;display: inline-block; margin-left: 70px; margin-top: 30px" placeholder="주소를 입력해주세요." value="${ resVO.addr }">
  	...
  	<input type="text" class="inputBox" id="latitude" name="latitude" style="width: 22%;display: inline-block; margin-left: 70px; margin-top: 30px" placeholder="위도를 입력해주세요." value="${ resVO.latitude }">
  	<label style="margin-left: 72px; margin-top: 30px">경도</label>
  	<input type="text" class="inputBox" id="longitude" name="longitude" style="width: 22%;display: inline-block; margin-left: 30px; margin-top: 30px" placeholder="경도를 입력해주세요." value="${ resVO.longitude }"><br/>
  	<label style="margin-left: 30px;">연락처</label>
  	<input type="text" class="inputBox" id="tel" name="tel" style="width: 60%;display: inline-block; margin-left: 55px; margin-top: 30px" placeholder="연락처를 입력해주세요." value="${ resVO.tel }"><br/>
  	...
  	<input type="text" class="inputBox" id="serviceHour" name="serviceHour" style="width: 60%;display: inline-block; margin-left: 70px" placeholder="이용시간을 입력해주세요." value="${ resVO.serviceHour }"><br/>
  		</div>
  		...
  		<c:forEach var="con" items="${convenienceArr }">
            ...
            <tr>
            <td>
            <textarea id="summernote" name="detailInfo">${  resVO.detailInfo }</textarea>
            </td>
            </tr>
            </tbody>
            </table>
            ...
            <input type="hidden" value="${ areaId }" id="areaId" name="areaId" >
               ...
               <form action="http://192.168.10.133/prj_travel/admin_restaurant/admin_restaurant_update_proccess.jsp" id="sub_frm" method="post" >
