...
<div class="wrap">
 ...
 <div class="head">
 <i class="bi bi-info-circle"></i><span>내가쓴글 - 리뷰</span>
  </div> 
 <div class="line"></div>
   <div class="wrapper">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" ><strong>관광지</strong></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th style="width: 120px">평가점수</th>
                    </tr>
                  </thead>
                  <tbody>

         <tr>
            <td><a href="touristarea_review.jsp">우도(해양도립공원)</a></td>
            <td>2023-09-28 </td>
            <td>3</td>
          </tr>                   
                  </tbody>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><strong>맛집</strong></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
         ...
         <tr>
            <td><a href="restaurant_review.jsp"> 봄날카페</a></td>
            <td>2023-09-28 </td>
            <td>3</td>
          </tr>                   
                  </tbody>
